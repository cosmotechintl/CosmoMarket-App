import 'package:cosmomarket/screen/futsal/futsal_book.dart';
import 'package:cosmomarket/theme/theme.dart';
import 'package:flutter/material.dart';
import 'package:flutter_rating_bar/flutter_rating_bar.dart';
import 'package:google_fonts/google_fonts.dart';

import '../../Model/futsalModel/futsal_model.dart';

class FutsalView extends StatefulWidget {
  const FutsalView({super.key});

  @override
  State<FutsalView> createState() => _FutsalViewState();
}

class _FutsalViewState extends State<FutsalView> {
    ...
    return GestureDetector(
      onTap: (){
            Navigator.push(context,
              MaterialPageRoute(
                  builder: (_) => FutsalBook(name: name)
              )
            );
      },
      child: Card(
